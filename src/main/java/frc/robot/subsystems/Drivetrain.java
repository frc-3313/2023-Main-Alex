...
import frc.robot.util.drive.SwerveModule;
import frc.robot.Constants.*;
import frc.robot.util.drive.FieldRelativeAccel;
import frc.robot.util.drive.FieldRelativeSpeed;
...
public class Drivetrain extends SubsystemBase {
  ...
  private final SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(DriveConstants.kDriveKinematics,
      ahrs.getRotation2d(), getModulePositions(), new Pose2d());
