...
public class SwerveModule {
  ...
  // Create a CanCoder to store the output of the absolute encoder that
  // tracks the angular position of the swerve module
  private final CANCoder m_turningAbsoluteEncoder;
  public CANCoderConfiguration swerveCanCoderConfig;
  public double m_angularOffset;
  ...
  public SwerveModule(int driveMotorChannel, int turningMotorChannel, int turningEncoderChannel, double angularOffset,
    ...
    m_turningAbsoluteEncoder = new CANCoder(turningEncoderChannel);
...
private Rotation2d getAngle(){
  ...
  public double getTurnEncoder() {
    return -1.0 * m_turningEncoder.getPosition();
  }
